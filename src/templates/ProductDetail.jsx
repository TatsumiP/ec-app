...
const useStyles = makeStyles((theme) => ({
    ...
    // returnCodeToBrはBrタグHTMLに変換する関数を別所で定義している。textが空白じゃなかったら改行をHTML仕様にする。
    // npm install --save html-react-parser　HTMLタグをreactのコンポーネントの中で使えるようにするパッケージ
    // HTMLReactParserは関数ではないので、importで{}をつけてはいけない
